import { EntityDieAfterEvent, EntityHurtAfterEvent, EntitySpawnAfterEvent, Player, world } from "@minecraft/server";

export default class MarineSlime {
    constructor() {
    ...
    spawnProtocol(arg) {
        ...
        arg.deadEntity.dimension.spawnEntity("cib:marine_slime", arg.deadEntity.location)
    }
    ...
    attackEffects(arg) {
        ...
        if (!(player instanceof Player) || damageSource.damagingEntity?.typeId != "cib:marine_slime") {
            return;
        }
