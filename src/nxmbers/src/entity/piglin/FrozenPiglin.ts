...
export default class FrozenPiglin {
    /**
     * @readonly
     */
     ...
     * @param event 
     */
    onAttack(event: { damage: any; damageSource: { damagingEntity: any; }; hurtEntity: any; }) {
        ...
        // @ts-ignore
        player.addEffect(slowness?.typeId, slowness?.duration, { "amplifier": slowness?.amplifier + 1 })
    }
}